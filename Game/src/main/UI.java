...
public class UI {
    ...
    public void drawBossHealth(Graphics2D g2) {
        // Полоска видна, если бой активен и игрок жив
        if (gp.bossFightActive && gp.player.life > 0) {
            int barWidth = 500;
            int barHeight = 30;
            ...
            int healthWidth = (int) (barWidth * ((double) gp.currentBoss.life / gp.currentBoss.maxLife));
            g2.fillRect(x, y, healthWidth, barHeight);

            g2.setColor(Color.WHITE);
            g2.setFont(new Font("Arial", Font.BOLD, 24));
            String name = gp.currentBoss.name;
